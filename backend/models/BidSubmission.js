...
const bidSubmissionSchema = new mongoose.Schema(
  {
    ...
    complianceStatus: { type: String, enum: ["COMPLIANT", "REVIEW_REQUIRED", "NON_COMPLIANT", "PASS", "REVIEW", "FAIL", null], default: null },
    aiRecommendation: { type: String, default: null },
    aiAssessmentDetails: { type: mongoose.Schema.Types.Mixed, default: null },
